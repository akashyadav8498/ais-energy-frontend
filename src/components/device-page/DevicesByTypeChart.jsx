...
export default function DevicesByTypeChart({ data }) {
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs">
      <h3 className="text-sm font-black text-slate-900 mb-3">Devices by Type</h3>
      <div className="flex items-center justify-between gap-2">
        <div className="relative w-28 h-28 flex items-center justify-center shrink-0">
          ...
          <div className="absolute text-center">
            <p className="text-base font-black text-slate-900 leading-none">342</p>
            <p className="text-[9px] font-bold text-slate-400 mt-0.5">Total</p>
          </div>
        </div>

        {/* Wrapped Layout preventing overflow */}
